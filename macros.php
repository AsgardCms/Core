...
Form::macro('i18nCheckbox', function ($name, $title, ViewErrorBag $errors, $lang, $object = null) {
    ...
    $string .= "<input id='{$lang}[{$name}]' name='{$lang}[{$name}]' type='checkbox' class='" . config('asgard.core.core.icheck-skin') . "'";
...
Form::macro('normalCheckbox', function ($name, $title, ViewErrorBag $errors, $object = null) {
    ...
    $string .= "<input id='$name' name='$name' type='checkbox' class='" . config('asgard.core.core.icheck-skin') . "'";
